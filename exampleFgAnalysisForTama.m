...
% Set fiber groups
 fiberName   = {'RORV13mmClipBigNotROI5_clean.pdb',...
   'RORV13mmClipBigNotROI5_clean_clean_D5_L4.mat',...
   'RORV13mmClipBigNotROI5_clean_WM.mat',...
     'LORV13mmClipBigNotROI5_clean.pdb',...
   'LORV13mmClipBigNotROI5_clean_clean_D5_L4.mat'...
   'LORV13mmClipBigNotROI5_clean_WM.mat'};
 
%  'LOT100_clean.pdb','ROT100_clean.pdb',...
%      'RORV13mmC_Not0801.pdb','RORV13mmC_Not0801_clean_D5_L4.mat',...
%      'RORV13mmClipBigNotROI5_clean_WM.mat'};
...
textFileName    = fullfile(baseDir,['FGVals_',dateAndTime,'.csv']);
[fid1 message]  = fopen(textFileName, 'w');
fprintf(fid1, 'Subject_Code FiberName Mean_FA Mean_MD Mean_RD Mean_AD NofFibers(arb) Mean_Length Min_Length Max_Length Mean_Score \n');
                ...
                if exist(fiberGroup,'file')
                    disp(['Computing dtiVals for ' fiberGroup ' ...']);
                        ...
                        fprintf(fid1,'%s %s %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f %.6f \n',...
                            subs{ii},name,avgFA,avgMD,avgRD,avgAD,numFibers,avgLength,minLength,maxLength,meanScore);
