function afq = SO_AFQ_SegmentCallosum(afq,overwriteFiles,sge)
...
if sge == 1
    for ii = 1:length(fgNames)
        afq = SO_AFQ_AddNewFiberGroup_sge(afq,fgNames{ii},roi1Names{ii},roi2Names{ii},1,1,0,segFgName,overwriteFiles(2));
    end
else
    for ii = 1:length(fgNames)
        afq = SO_AFQ_AddNewFiberGroup(afq,fgNames{ii},roi1Names{ii},roi2Names{ii},1,1,0,segFgName,overwriteFiles(2),20+ii);
    end
end
