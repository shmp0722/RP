function SO_AFQ_MakeFiberGroupMontage(afq, fgNames, fgColors, subNums, plotDims, numfibers)
...
for ii = subNums
    ...
    % Render the fibers
%     SO_AFQ_RenderFibers(fg, 'color', colors, 'numfibers',numfibers,'tubes',0,'subplot',[plotDims(1) plotDims(2) c]);
    SO_AFQ_RenderFibers(fg, 'color', colors, 'numfibers',numfibers,'tubes',1,'subplot',[plotDims(1) plotDims(2) c]);
